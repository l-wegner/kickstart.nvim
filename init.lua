...
-- Resize splits
vim.keymap.set('n', '<C-left>', '20<C-w><', { desc = 'Reduce witdh of the split' })
vim.keymap.set('n', '<C-right>', '20<C-w>>', { desc = 'Increase witdh of the split' })
vim.keymap.set('n', '<C-down>', '5<C-w>-', { desc = 'Reduce height of the split' })
vim.keymap.set('n', '<C-up>', '5<C-w>+', { desc = 'Increase height of the split' })
-- [[ Basic Autocommands ]]
